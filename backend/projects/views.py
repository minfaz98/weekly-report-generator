...
class AIInsightsView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        # 🌟 MANUAL KEY OVERRIDE SLOT: Paste your fresh AQ. key here if .env reading fails
        ...
        try:
            ...
            # Format raw request headers and body payload precisely matching Google v1beta expectations
            headers = {
            ...
            # Fire synchronous network post request over the raw wire
            response = requests.post(url, json=payload, headers=headers, timeout=30)
            response_data = response.json()
            
            # Check for direct wire level verification failures
            ...
            # Parse text value output from standard nested response schema
